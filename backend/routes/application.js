...
applicationsRouter.get('/:id', jwtAuthMiddleware, applicationsController.getById);
// POST create
applicationsRouter.post('/', jwtAuthMiddleware, applicationsController.create);
// PUT UPDATE ALL PROPERTIES
applicationsRouter.patch('/:id', jwtAuthMiddleware, applicationsController.update);
// DELETE
applicationsRouter.delete('/:id', jwtAuthMiddleware, applicationsController.delete);
